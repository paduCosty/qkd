...
<head>
    ...
    <title><?php echo e(config('app.name')); ?> — <?php echo e($title ?? 'Admin'); ?></title>
    ...
    <aside class="hidden md:flex flex-col fixed inset-y-0 left-0 w-60 bg-card border-r border-border z-50 overflow-y-auto">
        ...
        <nav class="flex-1 px-2 py-1 flex flex-col gap-0.5">
            <a href="<?php echo e(route('admin.dashboard')); ?>"
               class="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-[13px] font-medium transition-colors
                      <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-gold/10 text-gold font-semibold' : 'text-dim hover:bg-white/4 hover:text-content'); ?>">
            ...
            <a href="<?php echo e(route('admin.curriculum')); ?>"
               class="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-[13px] font-medium transition-colors
                      <?php echo e(request()->routeIs('admin.curriculum') || request()->routeIs('admin.grades.*') ? 'bg-gold/10 text-gold font-semibold' : 'text-dim hover:bg-white/4 hover:text-content'); ?>">
                <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <div class="px-3 py-4 border-t border-border">
            <div class="flex items-center gap-2.5 mb-3">
                ...
                <div class="min-w-0">
                    <div class="text-[13px] font-semibold leading-tight truncate"><?php echo e(auth()->user()->name); ?></div>
