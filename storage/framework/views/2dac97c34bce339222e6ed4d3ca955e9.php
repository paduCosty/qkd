        ...
        <div class="w-full max-w-sm">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($registered): ?>
                ...
                <div class="bg-card border border-emerald-500/30 rounded-2xl p-10 text-center shadow-[0_0_30px_rgba(201,150,15,.08)]">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="text-gold text-sm font-semibold hover:text-gold-light transition-colors">← Înapoi la autentificare</a>
                </div>
            <?php else: ?>
                        ...
                        <div>
                            ...
                            <input wire:model="name" type="text" placeholder="Ion Popescu" autocomplete="name"
                                   class="w-full bg-surface border rounded-lg px-3.5 py-3 text-content text-[15px] transition-colors
                                          <?php echo e($errors->has('name') ? 'border-red-500' : 'border-border'); ?>">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <input wire:model="password" type="password" placeholder="min. 8 caractere" autocomplete="new-password"
                                   class="w-full bg-surface border rounded-lg px-3.5 py-3 text-content text-[15px] transition-colors
                                          <?php echo e($errors->has('password') ? 'border-red-500' : 'border-border'); ?>">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="mt-5 pt-5 border-t border-border text-center">
                        ...
                        <a href="<?php echo e(route('login')); ?>" class="text-gold text-sm font-semibold hover:text-gold-light transition-colors">Autentifică-te</a>
                    </div>
                </div>
